                    ...
                    <form>
                        ...
                        <div class="mb-6 relative">
                            <div class="mb-6">
                                ...
                                />
                                <button @click="passwordVisibility = !passwordVisibility" type="button" class="absolute right-0 top-0 m-4 text-xl" style="right: 0.5rem">
                                    <span :class="[passwordVisibility ? 'fa-eye-slash' : 'fa-eye', 'fas']"></span>
                                </button>
                            </div>
                        </div>
...
<script setup>
    ...
    function login() {
        axios.post("http://3.84.116.122:8088/user/login", {
            ...
            .then(res => {
                ...
                if (res.data.code === '100') {
                    ...
                    document.cookie = `username=${loginForm.username};expires=${date.toUTCString()};SameSite=Secure;path=/`
